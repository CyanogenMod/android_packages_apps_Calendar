...
public class ImportActivity extends Activity {
    ...
    private long getLocalTimeFromString(String string) {
    ...
    private void parseCalFile() {
        File calFile = new File(getIntent().getData().getPath());
        VCalendar calendar = IcalendarUtils.readCalendarFromFile(calFile);
        ...
        String dtStart = calendar.getAllEvents().get(0).getProperty(VEvent.DTSTART);
        String dtEnd = calendar.getAllEvents().get(0).getProperty(VEvent.DTEND);
            ...
            builder.setTitle(R.string.cal_pick_ics)
                    .setItems(files, new DialogInterface.OnClickListener() {
                        public void onClick(DialogInterface dialog, int which) {
                            ...
                            File f = new File(EventInfoFragment.EXPORT_SDCARD_DIRECTORY, files[which]);
