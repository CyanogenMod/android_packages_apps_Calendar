...
public class EventInfoFragment extends DialogFragment implements OnCheckedChangeListener,
     ...
     * @param observer
     */
    private static synchronized void registerEventFileObserver(String filePath,
            EventFileObserver observer) {
     ...
     * @param observer
     */
    private static synchronized void unregisterEventFileObserver(String filePath,
            EventFileObserver observer) {
