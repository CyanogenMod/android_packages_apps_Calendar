...
public class ShareCalendarActivity extends Activity implements CalendarUtils.ShareEventListener {
    ...
    private String mSelectionAction;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mSelectionAction = mResources.getString(R.string.events_selection_share_action);
        String title = mShouldSelectSingleEvent ?
                mResources.getQuantityString(R.plurals.num_events_to_select, 1, mSelectionAction) :
                mResources.getQuantityString(R.plurals.num_events_to_select, 2, mSelectionAction);
